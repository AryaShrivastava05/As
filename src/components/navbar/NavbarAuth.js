...
export default function AuthNavbar(props) {
  ...
  let logoColor = useColorModeValue("#FFFDD0", "#FFFDD0");


  const textColor = useColorModeValue("#A020F0", "#FFFDD0");
  let menuBg = useColorModeValue("white", " #A020F0");
  let mainText = "#fff";
  let navbarBg = "none";
    ...
    return routes.map((link, key) => {
      return (
        <NavLink
          ...
          <Text color='#808080' fontSize='sm' fontWeight='normal'>
            {link.name}
          </Text>
        </NavLink>
      );
